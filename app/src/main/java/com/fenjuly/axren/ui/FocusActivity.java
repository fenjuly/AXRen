...
/**
 * Created by liurongchan on 16/4/11.
 */
public class FocusActivity extends AppCompatActivity {
    ...
    private void loadData() {
        RetrofitTool.getInstance().getFocusCount(AccessTokenKeeper.readAccessToken(this).getToken(), AccessTokenKeeper.readAccessToken(this).getUid())
                ...
                .subscribe(new Subscriber<Users>() {
                    ...
                    public void onNext(Users users) {
                        if (users != null) {
                            ...
                            fansAdapter = new FansAadapter(FocusActivity.this, userList);
